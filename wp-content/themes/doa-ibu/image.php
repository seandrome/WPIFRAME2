...
<?php if (have_posts()) : while (have_posts()) : the_post(); ?>
 <div class="post" id="post-<?php the_ID(); ?>"><div id="breadchumb"><?php if (function_exists('breadcrumbs')) breadcrumbs(); ?></div> 
...
<?php $fast_width  = apply_filters( 'wdt', 600 );  $fast_height = apply_filters( 'hgt', 600 );
echo wp_get_attachment_image( $post->ID, array( $fast_width, $fast_height ) ); 	?></a><?php else : ?><?php endif; ?></div>
<?php endwhile; ?>
<div class="picnav">
